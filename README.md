# Odoo 18 MCP Server (JSON-2 API) — SIT 環境

[![License: Apache-2.0](https://img.shields.io/badge/License-Apache_2.0-blue.svg)](LICENSE)
[![Python](https://img.shields.io/badge/Python-3.13-blue?logo=python&logoColor=white)](https://www.python.org/)
[![Environment](https://img.shields.io/badge/Environment-SIT-orange)](https://sit-odoo.eip.kkday.net/)
...
| 變數 | 說明 | 預設值 |
|------|------|--------|
| `ODOO_URL` | Odoo 伺服器 URL | `https://sit-odoo.eip.kkday.net/` |
...
1. 登入 Odoo（例如 https://sit-odoo.eip.kkday.net/）
